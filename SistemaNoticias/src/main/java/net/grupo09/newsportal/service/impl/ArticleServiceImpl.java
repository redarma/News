...
import net.grupo09.newsportal.service.UserService;
...
public class ArticleServiceImpl extends AbstractServiceImpl<Article> implements ArticleService {
	...
	/**
	 * @see net.grupo09.newsportal.service.ArticleService#add(
	 * net.grupo09.newsportal.domain.Article,java.lang.Long, java.lang.String, java.lang.String)
	 */
	@Override
	@Transactional
	...
	/**
	 * @see net.grupo09.newsportal.service.ArticleService#update(
	 * net.grupo09.newsportal.domain.Article, java.lang.String, java.lang.String)
	 */
	@Override
	@Transactional
	...
	/**
	 * @see net.grupo09.newsportal.service.ArticleService#get(java.lang.Long, java.lang.Long, boolean)
	 */
	@Override
	@Transactional
	...
	/**
	 * @see net.grupo09.newsportal.service.ArticleService#getByPage(int, int)
	 */
	@Override
	...
	/**
	 * @see net.grupo09.newsportal.service.ArticleService#getByPageByCategoryName(
	...
	/**
	 * @see net.grupo09.newsportal.service.ArticleService#getByPageByTagName(
	 * int, int, java.lang.String)
	 */
	@Override
	@Transactional(readOnly = true)
	...
	/**
	 * @see net.grupo09.newsportal.service.ArticleService#getByPageByUserId(
	...
	/**
	 * @see net.grupo09.newsportal.service.ArticleService#getByPageByFragment(
	 * int, int, java.lang.String)
	 */
	@Override
	@Transactional(readOnly = true)
	...
	/**
	 * @see net.grupo09.newsportal.service.ArticleService#addComment(
	 * net.grupo09.newsportal.domain.Comment, java.lang.Long, net.grupo09.newsportal.domain.Article)
	 */
	@Override
	@Transactional
