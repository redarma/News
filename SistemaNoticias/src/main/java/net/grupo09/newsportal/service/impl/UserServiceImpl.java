...
import net.grupo09.newsportal.domain.UserRole;
import net.grupo09.newsportal.exception.NotUniqueUserFieldException;
...
public class UserServiceImpl extends AbstractServiceImpl<User> implements UserService {
	 ...
	 * 
	 * @see net.grupo09.newsportal.service.impl.AbstractServiceImpl#add(java.io.Serializable)
	 */
	@Override
	@Transactional
	...
	/**
	 * @see net.grupo09.newsportal.service.UserService#getByLogin(java.lang.String)
	 */
	@Override
	...
	/**
	 * @see net.grupo09.newsportal.service.UserService#getByEmail(java.lang.String)
	 */
	@Override
	@Transactional(readOnly = true)
