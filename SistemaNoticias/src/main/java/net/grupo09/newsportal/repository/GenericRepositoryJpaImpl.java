package net.grupo09.newsportal.repository;
 ...
 * 
 * @see net.grupo09.newsportal.repository.GenericRepository
 * 
 * @author Juan
 */
@Repository
...
public class GenericRepositoryJpaImpl<T extends Serializable, PK extends Serializable>
	...
	/**
	 * @see net.grupo09.newsportal.repository.GenericRepository#setType(java.lang.Class)
	 */
	...
	/**
	 * @see net.grupo09.newsportal.repository.GenericRepository#add(java.lang.Object)
	 */
	@Override
	...
	/**
	 * @see net.grupo09.newsportal.repository.GenericRepository#get(java.io.Serializable)
	 */
	@Override
	public T get(PK id) {
	...
	/**
	 * @see net.grupo09.newsportal.repository.GenericRepository#update(java.lang.Object)
	 */
	@Override
	...
	/**
	 * @see net.grupo09.newsportal.repository.GenericRepository#delete(java.lang.Object)
	 */
	@Override
	...
	/**
	 * @see net.grupo09.newsportal.repository.GenericRepository#deleteById(java.io.Serializable)
	 */
	@Override
	...
	/**
	 * @see net.grupo09.newsportal.repository.GenericRepository#getByNamedQuery(
	...
	/**
	 * @see net.grupo09.newsportal.repository.GenericRepository#getAll()
	 */
	@Override
	...
	/**
	 * @see net.grupo09.newsportal.repository.GenericRepository#getAllByNamedQuery(
	 * java.lang.String)
	 */
	@Override
	...
	/**
	 * @see net.grupo09.newsportal.repository.GenericRepository#getAllNamesByNamedQuery(
	 * java.lang.String, java.util.Map, int, int)
	 */
	@Override
	...
	/**
	 * @see net.grupo09.newsportal.repository.GenericRepository#getCount()
	 */
	@Override
	public int getCount() {
	...
	/**
	 * @see net.grupo09.newsportal.repository.GenericRepository#getCountByNamedQuery(java.lang.String, java.util.Map)
	 */
	@Override
